...
# thing `opennextjs-cloudflare preview` does, minus the rebuild. Port 3000 is
# the Railway service's PORT. If the web process dies the container exits and
# Railway restarts everything.
