...
## Where OneCaptain fits

[OneCaptain](https://onecaptain.ai) is an open-source, self-hosted platform that turns local AI coding agents into a coordinated team. You describe roles and relationships; the agents collaborate without you writing orchestration code. It currently supports Claude Code, Codex, and OpenCode. The project lives on [GitHub](https://github.com/agentaler/onecaptain).

OneCaptain gives those agents an operating structure:

- Roles and an org chart that define who owns each kind of work
- An `@onecaptain.ai` email address so people and agents exchange instructions and replies
...
You can start for free: register at [onecaptain.ai](https://onecaptain.ai), then connect your local runtime or attach a cloud model API key. To set it up from your terminal:
