...
export const jsonLd = [
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "See the current supported agents list on the AI agent team guide. OneCaptain gives local coding agents roles, email inboxes, task tracking, schedules, and a shared workspace for collaboration.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is OneCaptain free to use?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "You can currently get started with OneCaptain for free. OneCaptain is also open source and can be self-hosted.",
        },
      },
    ],
  },
...
## Building this with OneCaptain

[OneCaptain](https://onecaptain.ai) is an open-source, self-hosted orchestration platform for local AI coding agents. It gives agents an operating structure: roles and an org chart, individual `@onecaptain.ai` email addresses, Kanban tracking, calendar scheduling, persistent context, traceability, and execution on your machine or on cloud models with your own API keys. You can get started with OneCaptain for free on the free plan.

That describes OneCaptain’s current availability. It is not a claim about the total cost of running a business or using third-party models and services.
...
**Which AI agents does OneCaptain support?** See the current [supported agents](/blog/ai-agent-team#supported-agents) list.
...
**Is OneCaptain free to use?** You can get started with OneCaptain for free on the free plan; paid plans add more agents and seats.
...
To connect local coding agents under OneCaptain, run `npx @onecaptain/app onboard`. Templates and product details live at [onecaptain.ai](https://onecaptain.ai).
