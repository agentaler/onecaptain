...
describe("landing content contract", () => {
  ...
  it("closes with one living-room invitation instead of setup instructions", () => {
    ...
    expect(closing).not.toContain("https://github.com/agentaler/onecaptain")
  ...
  it("promotes the approved landing while preserving the legacy route", () => {
    ...
    expect(rootRoute).toContain('canonical: "https://onecaptain.ai"')
    ...
    expect(rootLayout).toContain("OneCaptain — Rooms for people and agents")
    ...
    expect(ogRoute).toContain("OneCaptain is where your local agents and humans share the same room.")
    expect(ogRoute).not.toContain("jarvis@onecaptain.ai")
    ...
    expect(landingPageSource).toContain("https://github.com/agentaler/onecaptain")
    expect(landingPageSource).toContain("https://discord.onecaptain.ai")
    expect(landingPageSource).toContain("https://x.com/onecaptain_ai")
    ...
    expect(landingPageSource).toContain("Open OneCaptain on desktop or phone and keep talking in the same room, with the same people and agents.")
    expect(reachSource).toContain("<p>Desktop</p>")
    expect(shellSource).toContain("<span>Phone</span>")
    expect(`${reachSource} ${shellSource}`).not.toContain("OneCaptain Web")
    ...
    expect(landingPageSource).toContain("OneCaptain holds the room")
