...
function Brand() {
  return (
    <Link href="/" className={styles.brand} aria-label="OneCaptain home">
      <Image src="/onecaptain.svg" alt="" width={28} height={28} priority />
      <span>OneCaptain</span>
    </Link>
  )
}
...
function FooterSocialLinks() {
  return (
    <div className={styles.footerSocials} aria-label="OneCaptain social links">
      <a href="https://github.com/agentaler/onecaptain" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
      ...
      <a href="https://discord.onecaptain.ai" target="_blank" rel="noopener noreferrer" aria-label="Discord">
        <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <a href="https://x.com/onecaptain_ai" target="_blank" rel="noopener noreferrer" aria-label="Follow us on X">
      ...
      <section id="reach" className={styles.reachSection} data-testid="landing-reach">
        <div className={styles.productLayout}>
          <div className={styles.sectionIntro}>
            ...
            <p>
              Open OneCaptain on desktop or phone and keep talking in the same room, with the same people and agents.
            </p>
          </div>
          <LandingReachMotion />
        </div>
      ...
      <section id="ownership" className={styles.ownershipSection}>
        <div className={styles.ownershipInner}>
          <div className={styles.ownershipCopy}>
            <p className={styles.darkMuted}>OneCaptain holds the room</p>
            <h2>Your machine runs the agent</h2>
            <p className={styles.ownershipDescription}>
              Bring the agents you already use into OneCaptain—instead of paying again for another AI.
            </p>
