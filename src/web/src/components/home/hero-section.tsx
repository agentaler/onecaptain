    ...
    >
      ...
      <div className="hero-content relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center px-4 sm:px-6 py-8 max-h-full">
        ...
        <div className="hero-brand mb-6 flex shrink-0 items-center gap-2" style={{ opacity: 0 }}>
          <Image src="/onecaptain.svg" alt="OneCaptain" width={32} height={32} />
          <span
              ...
              >
                {subline === undefined ? (
                  <>
                    ...
                    Now you only need yourself and OneCaptain.
                  </>
                ) : subline}
              </p>
            )}
        ...
        {showClipboard && <div
          ...
          onClick={() => {
            navigator.clipboard.writeText(
              `Read ${window.location.origin}/onboard.md and follow the instructions to install and configure OneCaptain`
            );
            setCopied(true);
        ...
        >
          ...
          >
            <span className="flex-1 overflow-hidden whitespace-nowrap text-ellipsis">
              ...
              {" "}and follow the instructions to install and configure OneCaptain
            </span>
            <span
