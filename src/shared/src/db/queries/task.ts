...
const DEFAULT_STALE_SECONDS = Number(process.env.ONECAPTAIN_STALE_DISPATCH_TIMEOUT_S) || 20;
...
const DEFAULT_STALE_RUNNING_SECONDS = Number(process.env.ONECAPTAIN_STALE_RUNNING_TIMEOUT_S) || 3600;
