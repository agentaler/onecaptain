...
// ../community-schema.ts. Any schema change must be made in BOTH files until the
...
// 1. community_server
export const communityServer = pgTable(
  "community_server",
  {
...
export const communityCategory = pgTable(
  "community_category",
  {
    id: text("id").primaryKey().$defaultFn(() => nanoid()),
...
export const communityChannel: PgTableWithColumns<any> = pgTable(
  "community_channel",
  {
    id: text("id").primaryKey().$defaultFn(() => nanoid()),
...
export const communityChannelMember = pgTable(
...
// 5. community_message
export const communityMessage = pgTable(
  "community_message",
  {
    id: text("id").primaryKey().$defaultFn(() => nanoid()),
...
export const communityMessageSeq = pgTable("community_message_seq", {
  channelId: text("channel_id")
    .primaryKey()
    .references(() => communityChannel.id, { onDelete: "cascade" }),
...
export const communityServerMember = pgTable(
...
export const communityServerFolder = pgTable(
...
export const communityServerFolderItem = pgTable(
...
export const communityServerInvite = pgTable(
...
export const communityFriendship = pgTable(
...
// migration SQL.
export const communityReadState = pgTable(
...
// 15. community_pin
export const communityPin = pgTable(
  "community_pin",
  {
    id: text("id").primaryKey().$defaultFn(() => nanoid()),
    channelId: text("channel_id")
...
export const communityMention = pgTable(
  "community_mention",
  {
    id: text("id").primaryKey().$defaultFn(() => nanoid()),
    messageId: text("message_id")
...
export const communityUserProfile = pgTable("community_user_profile", {
  userId: text("user_id")
    .primaryKey()
    .references(() => user.id, { onDelete: "cascade" }),
...
export const communityNotificationSetting = pgTable(
...
export const communityAuditLog = pgTable(
  "community_audit_log",
  {
    id: text("id").primaryKey().$defaultFn(() => nanoid()),
...
export const communityBotApprovalRequest = pgTable(
...
export const communityBotActivityEvent = pgTable(
...
export const communityBotDailyActivity = pgTable(
...
export const communityMessageMark = pgTable(
...
export const communityMessageTag = pgTable(
